...
const SAMPLE = [
  { symbol: "RELIANCE.NS", name: "xxxxxReliance Industries" },
  ...
  { symbol: "ICICIBANK.NS", name: "ICICI Bank" },
  { symbol: "HDFCBANK.NS", name: "HDFC Bank" },
  { symbol: "xxxxxICICIBANK.NS", name: "xxxxxICICI Bank" },
];
...
const Watchlist = () => {
  ...
  return (
    <div className="w-60 h-full flex flex-col bg-white border border-[#e9e9e9] border-t-0">
      <div className="bg-white flex-shrink-0 border-b border-b-[#f3f4f6] p-2">
