...
//       <div>
//         <div className="text-[11px] uppercase tracking-[0.2em] text-[#6B7280] font-semibold">Market Pulse</div>
//         <h1 className="font-display text-3xl font-semibold tracking-tight text-[#111827] mt-1">Indian Market News</h1>
...
//         {loading && <div className="p-8 text-center text-sm text-[#6B7280]">Loading…</div>}
